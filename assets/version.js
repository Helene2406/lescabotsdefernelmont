...
// chaque livraison (voir CONVENTION-VERSIONS.md à la racine du dépôt).
// Repris automatiquement dans : le bandeau admin (admin.html, visible pour
// Katia ET Hélène), l'espace membre (VERSION_SITE interne), et le pied de
// page de toutes les pages publiques.
// ==========================================================================
export const VERSION_SITE = 'V01-010';
